...
|-----------------------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| `make test\|t`                    | `[--human]`                                                                                 | Run test suite (lint, format, type-check, pytest) on the newest declared Python |
| `make test-all`                   | `[--human]`                                                                                 | Run pytest + pyright on EVERY declared Python version, in parallel (the matrix) |
...
| `make clean\|cln\|cl`             |                                                                                             | Remove build artifacts and caches (KEEPS the venvs)                             |
| `make clean-all`                  |                                                                                             | Remove build artifacts, caches AND every virtual environment (`.venv*`)         |
...
| `make release\|rel\|r`            |                                                                                             | Tag `v` + the project version, push, create GitHub release via `gh`             |
